...
MODULES = [
    ...
    {'key': 'packing-bmr-numbering-log', 'title': 'Packing BMR Numbering Log', 'group': 'logs',
     'description': 'Batch numbering log for packing BMR issuance.'},
    ...
    {'key': 'document-reader-software-log', 'title': 'Document Reader Software Log', 'group': 'logs',
     'description': 'Upload and removal records for documents in the reader software.'},
    {'key': 'list-of-rationale', 'title': 'List of Rationale', 'group': 'logs',
     'description': 'Register of issued rationale documents.'},
    ...
    {'key': 'qrm-log', 'title': 'QRM Log', 'group': 'logs',
     'description': 'Quality risk management issuance and closure log.'},
    ...
    {'key': 'software-incident-log', 'title': 'Software Incident Log', 'group': 'logs',
     'url_name': 'software_incident_log', 'description': 'Computerised system incident register.'},
